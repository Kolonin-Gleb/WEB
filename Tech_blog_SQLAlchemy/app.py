...
# Создание объекта Flask основным файлом для работы с Flask будет файл app.py
app = Flask("__name__")
...
# Запуск проекта, как Flask приложение.
# Это основной файл проекта
if __name__ == "__main__":
    # Режим debug следует включить при разработке для того, чтобы видеть ошибки
